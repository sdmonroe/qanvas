...
OAT.DockWindow = function(content,options,dock) {
	...
	this.div = OAT.Dom.create("div",{marginBottom:"3px", border:"0px solid "+self.options.color,backgroundColor:"#fff"},"dock_window");
	
	this.header = OAT.Dom.create("div",{fontWeight:"normal",padding:"2px 2px",color:self.options.titleColor,backgroundColor:self.options.color},"dock_header");
