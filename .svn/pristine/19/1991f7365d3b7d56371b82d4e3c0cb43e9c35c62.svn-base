...
public class GGGPathResolver implements Serializable {

	static org.apache.log4j.Logger l = org.apache.log4j.Logger.getLogger(org.qanvas.GGGPathResolver.class);
	static {
	...
	public static String getViewData(CanvasView cv, String webid) {
		try {
			...
			Object[] goodies = Query.toQuery(path, cv.getDatatype(), webid);
